...
public class CourseScheduleUpdater implements ScheduledTask {
    @Autowired
    ...
    public CourseScheduleUpdater() {
    }

    public CourseScheduleUpdater(CourseDAOService courseDAOService, CourseRequesterService courseRequesterService) {
        this.courseDAOService = courseDAOService;
        this.courseRequesterService = courseRequesterService;
    }
